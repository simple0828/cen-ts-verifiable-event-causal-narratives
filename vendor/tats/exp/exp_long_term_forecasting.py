...
import warnings
import numpy as np
from utils.strict_llm import load_gpt2_strict, write_gpt2_manifest
    ...
    def __init__(self, args):
        ...
        if configs.llm_model == 'Doc2Vec':
            ...
            if configs.llm_model == 'LLAMA2':
                ...
                self.llm_model, self.tokenizer, self.gpt2_manifest = load_gpt2_strict(
                    configs.llm_path,
                    llm_layers=configs.llm_layers,
                )
                if getattr(configs, "gpt2_manifest_path", None):
                    write_gpt2_manifest(configs.gpt2_manifest_path, self.gpt2_manifest)
