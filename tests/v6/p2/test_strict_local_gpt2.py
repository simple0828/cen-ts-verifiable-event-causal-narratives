...
sys.path.insert(0, str(ROOT / "vendor" / "tats"))

from utils.strict_llm import build_gpt2_manifest


def test_strict_local_gpt2_manifest(local_gpt2):
    ...
    assert build_gpt2_manifest(local_gpt2)["weight_sha256"] == manifest["weight_sha256"]
