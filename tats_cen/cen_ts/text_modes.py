...
DEFAULT_TEXT_COLUMNS = {
    TextMode.RAW: "fact",
    TextMode.CONSTANT: "constant_fact",
    TextMode.SHUFFLED: "shuffled_fact",
    TextMode.EVENT: "event_fact",
    TextMode.CAUSAL_EVENT: "causal_fact",
    TextMode.VERIFIED_EVENT: "verified_fact",
    TextMode.APO_EVENT: "apo_fact",
}
