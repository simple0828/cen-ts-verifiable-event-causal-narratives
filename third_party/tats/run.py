...
from cen_ts.utils.paths import DEFAULT_GPT2_PATH, gpt2_path
...
from exp.exp_long_term_forecasting import Exp_Long_Term_Forecast
from cen_ts.data.text_modes import TextMode, resolve_text_column
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root', type=str, default='results', help='root directory for isolated CEN-TaTS runs')
    parser.add_argument('--run_name', type=str, default=None, help='run directory name under save_root')
    parser.add_argument('--prompt_version', type=str, default='raw_text_baseline_v1', help='text prompt/interface version')
